...
{
    /// <summary>Exp18: success-criteria freeze + audit via exp18_criteria.py.</summary>
    public static class Exp18Runner
    {
        public static int Run(string[] args)
        {
            string root = FindProjectRoot();
            string script = Path.Combine(root, "exp18_criteria.py");
